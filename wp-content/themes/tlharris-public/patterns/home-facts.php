<?php
/**
 * Title: Homepage — facts strip
 * Slug: tlharris-public/home-facts
 * Categories: tlharris
 * Inserter: no
 * Description: Four sourced facts under the homepage hero.
 */
?>
<!-- wp:html -->
...
<p class="tlharris-source">Sources: MSCS Board of Education; Tennessee Firefly, August 10, 2026; Chalkbeat Tennessee, April 14, 2026.</p>
<!-- /wp:paragraph -->
