...
- Never restate the role in template prose. The validator fails on `Board Member · District 6`, `Board Member for District 6` and `Memphis-Shelby County Schools Board Member` appearing in a template or part.
